...
for checkpoint_file in glob.glob('./*.pt'):
    ...
    test_image_data = SlideDataset.SlideDataset('test', '../settings/test_label.csv',
        '../gen_tiles_2000_step_1000/test_20X/',
        '../gen_tiles_1000/test_20X/',
        '../gen_tiles_500/test_20X/',
